window.onload = function() {
    ...
    function init() {
        ...
        snakeBody = new snake([[6, 4], [5, 4], [4, 4], [3, 4], [2, 4]], "right");
        appleBody = new apple([10, 10]);
        score = 0;
        refreshCanvas();
    ...
    function refreshCanvas() {
        ...
        if(snakeBody.checkCollision()) {
            ...
            if(snakeBody.isEatingApple(appleBody)) {
                
                snakeBody.eatApple = true;
                do {
                    score++;
                    appleBody.setNewPosition();
                }
                while(appleBody.isOnSnake(snakeBody))
            }
    ...
    document.onkeydown = function hendleKeyDown (e) {
        ...
        snakeBody.setDirection(newDirection);
    }
}